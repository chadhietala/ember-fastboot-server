...
define('fastboot-test/initializers/resource-discovery-ajax', ['exports'], function(exports) {
  /* globals najax, streamResponse, streamError */

  var dataDiscovery = function nodeAjax(options) {
    ...
    options.success = function() {
      ...
      streamResponse.apply(null, args);
   ...
   exports["default"] = {
    name: "resource-discovery-ajax",
    initialize: function(application) {
      application.register('ajax:resource-discovery', dataDiscovery, { instantiate: false });
      application.register('renderer:-noop', function() {}, { instantiate: false });
      application.inject('route', 'ajax', 'ajax:resource-discovery');
      application.inject('route', 'renderTemplate', 'renderer:-noop');
    }
   };
});
